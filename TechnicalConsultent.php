...
$sql = "SELECT heading, paragraph_content FROM consultancy_data WHERE status = 'active'";
...
<body>
    ...
    <p style="max-width: 100%; padding: 20px;text-align: center;"><?php echo $paragraph_content; ?></p>


<div class="container">
    <div class="rows">
           
         <?php include 'display_tecconsultancy.php'; ?>
