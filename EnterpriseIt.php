...
$sql = "SELECT id, solution_title, description, status FROM enterprise_solutions WHERE status = 'active'";
...
<body>
    ...
    <h1 style="text-align: center;"><?php echo $solution_title; ?></h1>
...
<div class="container">
    ...
    <?php include 'displayenterpriceit.php'; ?>
